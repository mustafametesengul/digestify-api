...
# from digestify_api.identity.username_claim import UsernameClaim
...
# ) -> TokenPair:
#     username_claim_json = await context.event_store.load("username_claims", payload.username)
#     username_claim = UsernameClaim.model_validate_json(username_claim_json)
